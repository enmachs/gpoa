...
class ObjectivesControllerTest < ActionController::TestCase
  ...
  test "should create objective" do
    assert_difference('Objective.count') do
      post :create, objective: { description: @objective.description, operative_plan_id: @objective.operative_plan_id, title: @objective.title }
    end
  ...
  test "should update objective" do
    patch :update, id: @objective, objective: { description: @objective.description, operative_plan_id: @objective.operative_plan_id, title: @objective.title }
    assert_redirected_to objective_path(assigns(:objective))
  end
